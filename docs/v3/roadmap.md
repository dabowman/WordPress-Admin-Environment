...
| **3c proper** — dashboard-host rewrite, command palette rewrite, classic wp-admin menu bridge | ✅ Shipped (3c.1 / 3c.2 / 3c.3 / 3c.4 all landed) | 3c.1: dashboard-host on `feat/v3-3c1-dashboard-host`; 3c.2 in `7d460a5`; 3c.3 in `968a3da`; 3c.4 in `134637f` |
| **3d** — migrate 5 remaining bundled shells, v2→v3 migration helper, final test surface | 🟡 In progress (3d.1 / 3d.2 / 3d.3 / 3d.5 shipped; 3d.4 doc sweep pending) | 3d.1: `f624231`, 3d.2: `51249de`, 3d.3 on `feat/v3-3d3-test-surface`, 3d.5: `8f39e5f` |
