...
| optgroup select / media picker / range in DataForm | General Settings controls | Not in `FORM_CONTROLS`; hand-roll or custom `Edit` | **[upstream]** dataviews (native) / **[workspace]** (escape hatch) |
