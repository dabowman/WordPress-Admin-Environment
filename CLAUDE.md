...
npm run test:runtime     # pure-ESM runtime modules (resolveRegion / validateRegion / routing / dataView / modes / build-runtime-config / theme-provider-host / kernel-no-ds-import / …)
