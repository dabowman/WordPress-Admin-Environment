...
npx wp-env run cli wp eval-file wp-content/plugins/WordPress-Admin-Environment/tests/php/run-alpha-trigger-tests.php       # wp-content/workspace.json override: partial-permissive load, baseline-in-core merge, workspace_active truth table, mtime cache signal
...
| 6 | Register a complete workspace | `wp_admin_workspaces_register_workspace( $slug, $admin_json )` — programmatic wins over file-based of same slug |
