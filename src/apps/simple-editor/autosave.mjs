 ...
 *
 * Mirrors core's autosaves controller (`class-wp-rest-autosaves-controller.php`):
 * for a draft / auto-draft / pending post the autosave updates the parent
 * record in place (`wp_update_post`), but for any other status — published,
 ...
 * @type {string[]}
 */
export const PARENT_AUTOSAVE_STATUSES = [ 'draft', 'auto-draft', 'pending' ];
