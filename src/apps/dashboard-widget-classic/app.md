...
- Provide an iframe fallback to `{adminUrl}index.php?wp_admin_shell_chromeless=1` for JS-driven widgets. This is the whole classic dashboard, not a single widget.
